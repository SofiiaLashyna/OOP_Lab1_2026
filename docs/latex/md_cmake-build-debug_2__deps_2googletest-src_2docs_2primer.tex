...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md227}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md227}%
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md228}{}\doxysection{\texorpdfstring{Introduction\+: Why Google\+Test?}{Introduction\+: Why Google\+Test?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md228}
...
Since Google\+Test is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used JUnit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md229}{}\doxysection{\texorpdfstring{Beware of the Nomenclature}{Beware of the Nomenclature}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md229}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md230}{}\doxysection{\texorpdfstring{Basic Concepts}{Basic Concepts}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md230}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md231}{}\doxysection{\texorpdfstring{Assertions}{Assertions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md231}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2assertions}{Assertions Reference}{0}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md232}{}\doxysection{\texorpdfstring{Simple Tests}{Simple Tests}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md232}
To create a test\+:
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{class_queue_ae6722c0f5afecd83719909a24f4902eb}{Queue}}();}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md233}{}\doxysection{\texorpdfstring{Invoking the Tests}{Invoking the Tests}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md233}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md234}{}\doxysection{\texorpdfstring{Writing the main() Function}{Writing the main() Function}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md234}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md235}{}\doxysection{\texorpdfstring{Known Limitations}{Known Limitations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md235}
