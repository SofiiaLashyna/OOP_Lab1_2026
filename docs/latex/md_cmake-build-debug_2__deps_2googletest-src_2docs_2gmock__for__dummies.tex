...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md204}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md204}%
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md205}{}\doxysection{\texorpdfstring{What Is g\+Mock?}{What Is g\+Mock?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md205}
...
\end{DoxyEnumerate}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md206}{}\doxysection{\texorpdfstring{Why g\+Mock?}{Why g\+Mock?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md206}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md207}{}\doxysection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md207}
g\+Mock is bundled with googletest.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md208}{}\doxysection{\texorpdfstring{A Case for Mock Turtles}{A Case for Mock Turtles}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md208}
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily MOCK\+\_\+\+METHOD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md211}{}\doxysubsection{\texorpdfstring{Where to Put It}{Where to Put It}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md211}
...
{\bfseries{Tip 2\+:}} If your mock objects are never deleted, the final verification won\textquotesingle{}t happen. Therefore it\textquotesingle{}s a good idea to turn on the heap checker in your tests when you allocate mocks on the heap. You get that automatically if you use the {\ttfamily gtest\+\_\+main} library already.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md213}{}\doxysubsubsubsubsection{\texorpdfstring{Expectation Ordering}{Expectation Ordering}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md213}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using g\+Mock. However, as we shall reveal soon, g\+Mock allows you to do {\itshape so much more} with the mocks.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md214}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md214}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. g\+Mock provides the necessary means for you to do it "{}just right."{}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md215}{}\doxysubsection{\texorpdfstring{General Syntax}{General Syntax}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md215}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} Why do we use a macro to do this? Well it serves two purposes\+: first it makes expectations easily identifiable (either by {\ttfamily grep} or by a human reader), and second it allows g\+Mock to include the source file location of a failed expectation in messages, making debugging easier.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md216}{}\doxysubsection{\texorpdfstring{Matchers\+: What Arguments Do We Expect?}{Matchers\+: What Arguments Do We Expect?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md216}
...
This works for all non-\/overloaded methods; if a method is overloaded, you need to help g\+Mock resolve which overload is expected by specifying the number of arguments and possibly also the \href{gmock_cook_book.md\#SelectOverload}{\texttt{types of the arguments}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md217}{}\doxysubsection{\texorpdfstring{Cardinalities\+: How Many Times Will It Be Called?}{Cardinalities\+: How Many Times Will It Be Called?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md217}
...
{\bfseries{Quick quiz\+:}} what do you think will happen if a function is expected to be called twice but actually called four times?\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md218}{}\doxysubsection{\texorpdfstring{Actions\+: What Should It Do?}{Actions\+: What Should It Do?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md218}
