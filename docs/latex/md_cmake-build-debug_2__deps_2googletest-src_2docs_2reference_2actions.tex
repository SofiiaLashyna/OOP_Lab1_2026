...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md246}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md246}%


\href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{{\bfseries{Actions}}}} specify what a mock function should do when invoked. This page lists the built-\/in actions provided by Google\+Test. All actions are defined in the {\ttfamily \+::testing} namespace.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md247}{}\doxysection{\texorpdfstring{Returning a Value}{Returning a Value}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md247}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md248}{}\doxysection{\texorpdfstring{Side Effects}{Side Effects}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md248}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md249}{}\doxysection{\texorpdfstring{Using a Function, Functor, or Lambda as an Action}{Using a Function, Functor, or Lambda as an Action}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md249}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string("{}Hi"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md250}{}\doxysection{\texorpdfstring{Default Action}{Default Action}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md250}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md251}{}\doxysection{\texorpdfstring{Composite Actions}{Composite Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md251}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md252}{}\doxysection{\texorpdfstring{Defining Actions}{Defining Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions_autotoc_md252}
