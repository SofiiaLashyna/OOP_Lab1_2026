...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md222}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md222}%
...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md223}{}\doxysubsection{\texorpdfstring{CMake}{CMake}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md223}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md225}{}\doxysubsection{\texorpdfstring{Using pkg-\/config in a cross-\/compilation setting}{Using pkg-\/config in a cross-\/compilation setting}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2pkgconfig_autotoc_md225}
