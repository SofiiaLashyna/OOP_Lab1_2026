...
For convenience, we allow the description string to be empty ({\ttfamily "{}"{}}), in which case g\+Mock will use the sequence of words in the matcher name as the description.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md168}{}\doxysubsubsection{\texorpdfstring{Basic Example}{Basic Example}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md168}
...
where the descriptions {\ttfamily "{}is divisible by 7"{}} and {\ttfamily "{}not (is divisible by 7)"{}} are automatically calculated from the matcher name {\ttfamily Is\+Divisible\+By7}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md169}{}\doxysubsubsection{\texorpdfstring{Adding Custom Failure Messages}{Adding Custom Failure Messages}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md169}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md170}{}\doxysubsubsection{\texorpdfstring{Using EXPECT\+\_\+ Statements in Matchers}{Using EXPECT\+\_\+ Statements in Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md170}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md171}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Match\+And\+Explain}}{{\ttfamily Match\+And\+Explain}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md171}
You should let {\ttfamily Match\+And\+Explain()} print {\itshape any additional information} that can help a user understand the match result. Note that it should explain why the match succeeds in case of a success (unless it\textquotesingle{}s obvious) -\/ this is useful when the matcher is used inside {\ttfamily Not()}. There is no need to print the argument value itself, as g\+Mock already prints it for you.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md172}{}\doxysubsubsection{\texorpdfstring{Argument Types}{Argument Types}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md172}
The type of the value being matched ({\ttfamily arg\+\_\+type}) is determined by the context in which you use the matcher and is supplied to you by the compiler, so you don\textquotesingle{}t need to worry about declaring it (nor can you). This allows the matcher to be polymorphic. For example, {\ttfamily Is\+Divisible\+By7()} can be used to match any type where the value of {\ttfamily (arg \% 7) == 0} can be implicitly converted to a {\ttfamily bool}. In the {\ttfamily Bar(\+Is\+Divisible\+By7())} example above, if method {\ttfamily Bar()} takes an {\ttfamily int}, {\ttfamily arg\+\_\+type} will be {\ttfamily int}; if it takes an {\ttfamily unsigned long}, {\ttfamily arg\+\_\+type} will be {\ttfamily unsigned long}; and so on.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md173}{}\doxysubsection{\texorpdfstring{Writing New Parameterized Matchers Quickly}{Writing New Parameterized Matchers Quickly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md173}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener\texorpdfstring{$\ast$}{*}} instead of {\ttfamily std\+::ostream\texorpdfstring{$\ast$}{*}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md175}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Matchers}{Writing New Polymorphic Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md175}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md176}{}\doxysubsection{\texorpdfstring{Legacy Matcher Implementation}{Legacy Matcher Implementation}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md176}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CompositeMatchers}{}\doxysubsection{\texorpdfstring{Implementing Composite Matchers}{Implementing Composite Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CompositeMatchers}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily \doxylink{class_action}{Action}} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \doxylink{gmock-actions_8h_source}{gmock-\/actions.\+h}} for examples.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md178}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based Actions}{Legacy macro-\/based Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md178}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md179}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based parameterized Actions}{Legacy macro-\/based parameterized Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md179}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md180}{}\doxysubsection{\texorpdfstring{Restricting the Type of an Argument or Parameter in an ACTION}{Restricting the Type of an Argument or Parameter in an ACTION}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md180}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md181}{}\doxysubsection{\texorpdfstring{Writing New Action Templates Quickly}{Writing New Action Templates Quickly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md181}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md182}{}\doxysubsection{\texorpdfstring{Using the ACTION Object\textquotesingle{}s Type}{Using the ACTION Object\textquotesingle{}s Type}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md182}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md183}{}\doxysubsection{\texorpdfstring{Teaching g\+Mock How to Print Your Values}{Teaching g\+Mock How to Print Your Values}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md183}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md184}{}\doxysection{\texorpdfstring{Useful Mocks Created Using g\+Mock}{Useful Mocks Created Using g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md184}
