...
\DoxyCodeLine{00904\ }
\DoxyCodeLine{00905\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1_message}{Message}};}
\DoxyCodeLine{00906\ }
...
\DoxyCodeLine{00920\ \textcolor{keyword}{class\ }Secret\ \{}
\DoxyCodeLine{00921\ \ \ Secret(\textcolor{keyword}{const}\ Secret\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00922\ \};}
\DoxyCodeLine{00923\ }
...
\DoxyCodeLine{01030\ \textcolor{keyword}{class\ }GTEST\_API\_\ GTestLog\ \{}
\DoxyCodeLine{01031\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01032\ \ \ GTestLog(GTestLogSeverity\ severity,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ file,\ \textcolor{keywordtype}{int}\ line);}
\DoxyCodeLine{01033\ }
\DoxyCodeLine{01034\ \ \ \textcolor{comment}{//\ Flushes\ the\ buffers\ and,\ if\ severity\ is\ GTEST\_FATAL,\ aborts\ the\ program.}}
\DoxyCodeLine{01035\ \ \ \string~GTestLog();}
\DoxyCodeLine{01036\ }
...
\DoxyCodeLine{01041\ }
\DoxyCodeLine{01042\ \ \ GTestLog(\textcolor{keyword}{const}\ GTestLog\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{01043\ \ \ GTestLog\&\ operator=(\textcolor{keyword}{const}\ GTestLog\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{01044\ \};}
\DoxyCodeLine{01045\ }
...
\DoxyCodeLine{01102\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1_const_ref}{ConstRef}}\ \{}
...
\DoxyCodeLine{01106\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1_const_ref}{ConstRef}}<T\&>\ \{}
...
\DoxyCodeLine{01135\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classtesting_1_1internal_1_1_to}{To}}\ ImplicitCast\_(\mbox{\hyperlink{classtesting_1_1internal_1_1_to}{To}}\ x)\ \{}
...
\DoxyCodeLine{01372\ \textcolor{keyword}{class\ }GTEST\_API\_\ \mbox{\hyperlink{classtesting_1_1internal_1_1_mutex}{Mutex}}\ \{}
...
\DoxyCodeLine{01425\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_g_test_mutex_lock}{GTestMutexLock}}\ \{}
...
\DoxyCodeLine{01436\ \};}
\DoxyCodeLine{01437\ }
\DoxyCodeLine{01438\ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classtesting_1_1internal_1_1_g_test_mutex_lock}{GTestMutexLock}}\ MutexLock;}
\DoxyCodeLine{01439\ }
...
\DoxyCodeLine{01556\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal}}\ :\ \textcolor{keyword}{public}\ ThreadLocalBase\ \{}
...
\DoxyCodeLine{01699\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_mutex}{Mutex}}\ :\ \textcolor{keyword}{public}\ MutexBase\ \{}
...
\DoxyCodeLine{01717\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_g_test_mutex_lock}{GTestMutexLock}}\ \{}
...
\DoxyCodeLine{01728\ \};}
\DoxyCodeLine{01729\ }
\DoxyCodeLine{01730\ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classtesting_1_1internal_1_1_g_test_mutex_lock}{GTestMutexLock}}\ MutexLock;}
\DoxyCodeLine{01731\ }
...
\DoxyCodeLine{01751\ \textcolor{keyword}{class\ }GTEST\_API\_\ \mbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal}}\ \{}
...
\DoxyCodeLine{01863\ }
\DoxyCodeLine{01864\ \textcolor{keyword}{class\ }Mutex\ \{}
\DoxyCodeLine{01865\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01866\ \ \ Mutex()\ \{\}}
...
\DoxyCodeLine{01882\ \textcolor{keyword}{class\ }GTestMutexLock\ \{}
\DoxyCodeLine{01883\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01884\ \ \ \textcolor{keyword}{explicit}\ GTestMutexLock(\mbox{\hyperlink{classtesting_1_1internal_1_1_mutex}{Mutex}}*)\ \{\}\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{01885\ \};}
\DoxyCodeLine{01886\ }
\DoxyCodeLine{01887\ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classtesting_1_1internal_1_1_g_test_mutex_lock}{GTestMutexLock}}\ MutexLock;}
\DoxyCodeLine{01888\ }
\DoxyCodeLine{01889\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{01890\ \textcolor{keyword}{class\ }GTEST\_API\_\ ThreadLocal\ \{}
\DoxyCodeLine{01891\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01892\ \ \ ThreadLocal()\ :\ value\_()\ \{\}}
\DoxyCodeLine{01893\ \ \ \textcolor{keyword}{explicit}\ ThreadLocal(\textcolor{keyword}{const}\ T\&\ value)\ :\ value\_(value)\ \{\}}
...
\DoxyCodeLine{02198\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_type_with_size}{TypeWithSize}}\ \{}
...
\DoxyCodeLine{02207\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_type_with_size}{TypeWithSize}}<4>\ \{}
...
\DoxyCodeLine{02215\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_type_with_size}{TypeWithSize}}<8>\ \{}
...
\DoxyCodeLine{02312\ GTEST\_API\_\ \textcolor{keywordtype}{bool}\ ParseInt32(\textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1_message}{Message}}\&\ src\_text,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str,}
...
\DoxyCodeLine{02324\ }
\DoxyCodeLine{02325\ \textcolor{preprocessor}{\#if\ GTEST\_INTERNAL\_HAVE\_CPP\_ATTRIBUTE(clang::annotate)}}
\DoxyCodeLine{02326\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_DEPRECATE\_AND\_INLINE(msg)\ \(\backslash\)}}
\DoxyCodeLine{02327\ \textcolor{preprocessor}{\ \ [[deprecated(msg),\ clang::annotate("{}inline-\/me"{})]]}}
\DoxyCodeLine{02328\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{02329\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_DEPRECATE\_AND\_INLINE(msg)\ [[deprecated(msg)]]}}
\DoxyCodeLine{02330\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{02331\ }
\DoxyCodeLine{02332\ \textcolor{preprocessor}{\#if\ defined(\_\_cpp\_lib\_span)\ ||\ (GTEST\_INTERNAL\_HAS\_INCLUDE(<span>)\ \&\&\ \(\backslash\)}}
\DoxyCodeLine{02333\ \textcolor{preprocessor}{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ GTEST\_INTERNAL\_CPLUSPLUS\_LANG\ >=\ 202002L)}}
\DoxyCodeLine{02334\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_STD\_SPAN\ 1}}
\DoxyCodeLine{02335\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ \_\_cpp\_lib\_span}}
\DoxyCodeLine{02336\ }
\DoxyCodeLine{02337\ \textcolor{preprocessor}{\#ifndef\ GTEST\_INTERNAL\_HAS\_STD\_SPAN}}
\DoxyCodeLine{02338\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_STD\_SPAN\ 0}}
\DoxyCodeLine{02339\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{02340\ }
\DoxyCodeLine{02341\ \textcolor{preprocessor}{\#ifdef\ GTEST\_HAS\_ABSL}}
\DoxyCodeLine{02342\ \textcolor{comment}{//\ Always\ use\ absl::string\_view\ for\ Matcher<>\ specializations\ if\ googletest}}
\DoxyCodeLine{02343\ \textcolor{comment}{//\ is\ built\ with\ absl\ support.}}
\DoxyCodeLine{02344\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_STRING\_VIEW\ 1}}
\DoxyCodeLine{02345\ \textcolor{preprocessor}{\#include\ "{}absl/strings/string\_view.h"{}}}
\DoxyCodeLine{02346\ \textcolor{keyword}{namespace\ }testing\ \{}
\DoxyCodeLine{02347\ \textcolor{keyword}{namespace\ }internal\ \{}
\DoxyCodeLine{02348\ \textcolor{keyword}{using\ }StringView\ =\ ::absl::string\_view;}
...
\DoxyCodeLine{02352\ \textcolor{preprocessor}{\#if\ defined(\_\_cpp\_lib\_string\_view)\ ||\ \ \ \ \ \ \ \ \ \ \ \ \ \(\backslash\)}}
\DoxyCodeLine{02353\ \textcolor{preprocessor}{\ \ \ \ (GTEST\_INTERNAL\_HAS\_INCLUDE(<string\_view>)\ \&\&\ \(\backslash\)}}
\DoxyCodeLine{02354\ \textcolor{preprocessor}{\ \ \ \ \ GTEST\_INTERNAL\_CPLUSPLUS\_LANG\ >=\ 201703L)}}
\DoxyCodeLine{02355\ \textcolor{comment}{//\ Otherwise\ for\ C++17\ and\ higher\ use\ std::string\_view\ for\ Matcher<>}}
\DoxyCodeLine{02356\ \textcolor{comment}{//\ specializations.}}
\DoxyCodeLine{02357\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_STRING\_VIEW\ 1}}
\DoxyCodeLine{02358\ \textcolor{preprocessor}{\#include\ <string\_view>}}
\DoxyCodeLine{02359\ \textcolor{keyword}{namespace\ }testing\ \{}
\DoxyCodeLine{02360\ \textcolor{keyword}{namespace\ }internal\ \{}
\DoxyCodeLine{02361\ \textcolor{keyword}{using\ }StringView\ =\ ::std::string\_view;}
\DoxyCodeLine{02362\ \}\ \ \textcolor{comment}{//\ namespace\ internal}}
\DoxyCodeLine{02363\ \}\ \ \textcolor{comment}{//\ namespace\ testing}}
\DoxyCodeLine{02364\ \textcolor{comment}{//\ The\ case\ where\ absl\ is\ configured\ NOT\ to\ alias\ std::string\_view\ is\ not}}
\DoxyCodeLine{02365\ \textcolor{comment}{//\ supported.}}
\DoxyCodeLine{02366\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ \_\_cpp\_lib\_string\_view}}
\DoxyCodeLine{02367\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GTEST\_HAS\_ABSL}}
\DoxyCodeLine{02368\ }
\DoxyCodeLine{02369\ \textcolor{preprocessor}{\#ifndef\ GTEST\_INTERNAL\_HAS\_STRING\_VIEW}}
\DoxyCodeLine{02370\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_STRING\_VIEW\ 0}}
\DoxyCodeLine{02371\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{02372\ }
\DoxyCodeLine{02373\ \textcolor{preprocessor}{\#if\ (defined(\_\_cpp\_lib\_three\_way\_comparison)\ ||\ \(\backslash\)}}
\DoxyCodeLine{02374\ \textcolor{preprocessor}{\ \ \ \ \ (GTEST\_INTERNAL\_HAS\_INCLUDE(<compare>)\ \&\&\ \ \(\backslash\)}}
\DoxyCodeLine{02375\ \textcolor{preprocessor}{\ \ \ \ \ \ GTEST\_INTERNAL\_CPLUSPLUS\_LANG\ >=\ 201907L))}}
\DoxyCodeLine{02376\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_COMPARE\_LIB\ 1}}
\DoxyCodeLine{02377\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{02378\ \textcolor{preprocessor}{\#define\ GTEST\_INTERNAL\_HAS\_COMPARE\_LIB\ 0}}
\DoxyCodeLine{02379\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{02380\ }
\DoxyCodeLine{02381\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GOOGLETEST\_INCLUDE\_GTEST\_INTERNAL\_GTEST\_PORT\_H\_}}
