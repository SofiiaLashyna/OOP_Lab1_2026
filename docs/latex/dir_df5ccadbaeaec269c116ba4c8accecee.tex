...
\item 
directory \mbox{\hyperlink{dir_40dae5e833f04320c1fc0eb4f9262cb0}{docs}}
\item 
directory \mbox{\hyperlink{dir_47dc1212d4acce3e63aa4c4ebb8bb477}{samples}}
\item 
directory \mbox{\hyperlink{dir_b8a44fd9f372c960e9cf58fcb351e49e}{src}}
\item 
directory \mbox{\hyperlink{dir_88f5d3db4b63e676f7ecffb5e4682f3b}{test}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md398}{}\doxysubsection{\texorpdfstring{Generic Build Instructions}{Generic Build Instructions}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md398}
\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md399}{}\doxysubsubsubsection{\texorpdfstring{Setup}{Setup}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md399}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md400}{}\doxysubsubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md400}
...
CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md401}{}\doxysubsubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md401}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md402}{}\doxysubsubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md402}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md403}{}\doxysubsubsubsubsection{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md403}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md404}{}\doxysubsubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md404}
An environment that supports C++17 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 17)} command along with {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD\+\_\+\+REQUIRED ON)}. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the{\ttfamily -\/DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md405}{}\doxysubsubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md405}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md406}{}\doxysubsubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md406}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{https://gcc.gnu.org/wiki/Visibility}{\texttt{https\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google\+Test as a shared library. Otherwise a future release of Google\+Test may break your build script.\hypertarget{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md408}{}\doxysubsubsection{\texorpdfstring{Avoiding Macro Name Clashes}{Avoiding Macro Name Clashes}}\label{dir_df5ccadbaeaec269c116ba4c8accecee_autotoc_md408}
