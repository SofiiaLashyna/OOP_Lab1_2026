...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md241}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md241}%


This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel}{Quickstart for Bazel}{0} instead.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md242}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md242}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md243}{}\doxysection{\texorpdfstring{Set up a project}{Set up a project}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md243}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{CMake Tutorial}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md244}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md244}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md245}{}\doxysection{\texorpdfstring{Next steps}{Next steps}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md245}
